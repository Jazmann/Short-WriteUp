...
First, the overall scaling for the quantized rotation matrix is found by combining the normalized scaling $\Scale[\theta, n]$ with the desired scaling defined in Equation (\ref{eq:CombinedRotationRange}):
