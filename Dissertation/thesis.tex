...
% !TeX TXS-program:compile = txs:///pdflatex --shell-escape --enable-write18 
% ******************************* PhD Thesis Template **************************
...
\immediate\write18{texcount -nosub  thesis.tex -inc -out=thesis.sum}
...
\crest{\includegraphics[width=0.25\textwidth]{Figs/University_Crest.pdf}}
...
\include{Chapter2/AppendixChapter2}
\include{Chapter3/AppendixChapter3}
\include{Chapter4/AppendixChapter4}
